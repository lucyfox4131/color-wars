...
console.log(coordsInBoard.indexOf("146:106"))


context.beginPath();
context.moveTo(304, 201 - 35);
context.bezierCurveTo(304 + (0.5522847498307936 * 51), 201 - 35,  304 + 51, 201 - (0.5522847498307936 * 35), 304 + 51, 201);
context.bezierCurveTo(304 + 51, 201 + (0.5522847498307936 * 35), 304 + (0.5522847498307936 * 51), 201 + 35, 304, 201 + 35);
context.bezierCurveTo(304 - (0.5522847498307936 * 51), 201 + 35, 304 - 51, 201 + (0.5522847498307936 * 35), 304 - 51, 201);
context.bezierCurveTo(304 - 51, 201 - (0.5522847498307936 * 35), 304 - (0.5522847498307936 * 51), 201 - 35, 304, 201 - 35);
context.moveTo(355.5, 243.5 - 34.5);
context.bezierCurveTo(355.5 + (0.5522847498307936 * 46.5), 243.5 - 34.5,  355.5 + 46.5, 243.5 - (0.5522847498307936 * 34.5), 355.5 + 46.5, 243.5);
context.bezierCurveTo(355.5 + 46.5, 243.5 + (0.5522847498307936 * 34.5), 355.5 + (0.5522847498307936 * 46.5), 243.5 + 34.5, 355.5, 243.5 + 34.5);
context.bezierCurveTo(355.5 - (0.5522847498307936 * 46.5), 243.5 + 34.5, 355.5 - 46.5, 243.5 + (0.5522847498307936 * 34.5), 355.5 - 46.5, 243.5);
context.bezierCurveTo(355.5 - 46.5, 243.5 - (0.5522847498307936 * 34.5), 355.5 - (0.5522847498307936 * 46.5), 243.5 - 34.5, 355.5, 243.5 - 34.5);
context.moveTo(404.5, 287.5 - 43.5);
context.bezierCurveTo(404.5 + (0.5522847498307936 * 48.5), 287.5 - 43.5,  404.5 + 48.5, 287.5 - (0.5522847498307936 * 43.5), 404.5 + 48.5, 287.5);
context.bezierCurveTo(404.5 + 48.5, 287.5 + (0.5522847498307936 * 43.5), 404.5 + (0.5522847498307936 * 48.5), 287.5 + 43.5, 404.5, 287.5 + 43.5);
context.bezierCurveTo(404.5 - (0.5522847498307936 * 48.5), 287.5 + 43.5, 404.5 - 48.5, 287.5 + (0.5522847498307936 * 43.5), 404.5 - 48.5, 287.5);
context.bezierCurveTo(404.5 - 48.5, 287.5 - (0.5522847498307936 * 43.5), 404.5 - (0.5522847498307936 * 48.5), 287.5 - 43.5, 404.5, 287.5 - 43.5);
context.closePath();
context.lineWidth = 5;
...
var coordsInCircleBoard = [];

for(i = 0; i <= 500; i++){
  for(j = 0; j <= 500; j++){
    if (context.isPointInPath(i, j)) coordsInCircleBoard.push(i + ":" + j);
  }
}

console.log(coordsInCircleBoard);
